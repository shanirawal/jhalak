import {
  ...
  export default function ElasticSlider({
    ...
    return (
      <div className={`flex flex-col items-center justify-center gap-4 w-96 ${className}`}>
        <Slider
          id={id}
  ...
  function Slider({
    ...
    const handlePointerMove = (e) => {
      if (e.buttons > 0 && sliderRef.current) {
        ...
        // ✅ Send value to parent as float
        onAnswerSelect(id, parseFloat(newValue.toFixed(1)));
      }
    };
